...
public class TBinaryProtocol extends TProtocol {
  ...
  private static Logger logger = LoggerFactory.getLogger(TBinaryProtocol.class);
  ...
  public void writeByte(byte b) throws TException {
    /*try 
    {
    	throw new RuntimeException("In WriteByte");
    }
    catch (Exception e)
    {	
    ...
    int val=b;
    /*logger.debug("Got Byte "+ val + " in Client Side");  
    logger.debug("Transport used is {}", trans_); */
    bout[0] = b;
